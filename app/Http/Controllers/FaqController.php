...
class FaqController extends Controller
{
    public function index(Request $request)
    {
        ...
        $all_data = Faq::join('subcourses', 'subcourses.id', '=', 'faq.course_id')
        ->where('course_id',$request->id)
        ->get(['faq.*','subcourses.name AS subcoursename']);
    ...
    public function all_faq(Request $request)
    {
        ...
        return response()->json(['data'=>$response,'status' => 'Success', 'message' => 'Fetched All Data Successfully','StatusCode'=>'200']);        return response()->json(['data'=>$all_data,'status' => 'Success', 'message' => 'Fetched All Data Successfully','StatusCode'=>'200']);
    }
